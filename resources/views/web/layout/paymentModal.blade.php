    ...
    <div id="paymentModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative max-h-full w-full max-w-lg p-4">
            ...
            <div class="relative rounded-lg bg-white p-4 shadow dark:bg-gray-800 sm:p-5">
                ...
                <!-- Modal body -->
                <div
                    class="mb-4 flex items-center justify-between rounded-lg border border-gray-200 bg-gray-50 p-4 ps-4 dark:border-gray-600 dark:bg-gray-700 md:mb-5">
                    <div>
                        <div class="flex items-start">
                            <div class="flex h-5 items-center">
                                <input id="mastercard-modal" aria-describedby="mastercard-text-modal" type="radio"
                            ...
                            <div class="ms-4 text-sm">
                                <label for="mastercard-modal" class="font-medium text-gray-900 dark:text-white">
                                    Mastercard ending in 8429 </label>
                                <p id="mastercard-text-modal"
                                    class="text-xs font-normal text-gray-500 dark:text-gray-400">Expiry 04/2026</p>
                            </div>
                        </div>
                ...
                <div
                    ...
                    <div>
                        <div class="flex items-start">
                            <div class="flex h-5 items-center">
                                <input id="paypal-modal" aria-describedby="paypal-text-modal" type="radio"
                                    name="payment-method" value=""
                                    class="h-4 w-4 border-gray-300 bg-white text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
                            </div>

                            <div class="ms-4 text-sm">
                                <label for="paypal-modal" class="font-medium text-gray-900 dark:text-white"> Paypal
                                    account </label>
                            </div>
                        </div>
                ...
                <div class="mb-6 grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label for="card-expiration-input-3"
                        ...
                        <div class="relative">
                            ...
                            <input datepicker datepicker-format="mm/yy" id="card-expiration-input-3" type="text"
                    ...
                    <div>
                        <label for="cvv-input-3"
                            class="mb-2 flex items-center gap-1 text-sm font-medium text-gray-900 dark:text-white">
                            CVV*
                            <button data-tooltip-target="cvv-desc-modal" data-tooltip-trigger="hover"
                            ...
                            <div id="cvv-desc-modal" role="tooltip"
                        ...
                        <div class="relative">
                            <input type="number" id="cvv-input-3" aria-describedby="helper-text-explanation"
                ...
                <div
                    ...
                    <form action="/order/store" method="post" class="w-full flex gap-4">
                        @csrf
                        <input hidden type="text" name="product_id" id="product_id" value="{{ $productsID }}">
                        <input hidden type="email" name="user_email" id="user_email" value="{{ auth()->user()->email }}">
                        <input hidden type="number" name="price" id="price" value="{{ $totalPrice }}">
                        @if (auth()->user()->role === '1')
                            <input hidden type="number" name="discount" id="discount" value="{{ $totalDiscount }}">
                        ...
                        @else
                            <input hidden type="number" name="discount" id="discount"
                                value="{{ $totalDiscount + $totalPrice * 0.05 }}">
                            <input hidden type="number" name="final_price" id="final_price"
                                value="{{ $totalPrice - $totalDiscount - ($totalPrice * 0.05) }}">
                        @endif
                        <input hidden type="text" name="status" id="status" value="1">
                        <input hidden type="text" name="courier" id="courier" value="home-texere">
                        <button type="submit"
                            class="flex w-full justify-center rounded-lg border border-gray-200 px-5 py-2.5 text-sm font-medium hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600  dark:hover:bg-primary-700 dark:focus:ring-primary-800 sm:mt-0 sm:w-auto">Pay
                            now</button>
