        ...
        <div class="relative max-h-full w-full max-w-lg p-4">
            ...
            <div class="relative rounded-lg bg-white p-4 shadow dark:bg-gray-800 sm:p-5">
                ...
                <div
                    ...
                    <form action="/users/{{ auth()->user()->id }}" method="post" class="w-full flex gap-4">
                        @method('PUT')
                        @csrf
                        <input hidden type="text" name="name" id="name"
                            value="{{ auth()->user()->name }}">
                        <input hidden type="email" name="email" id="email"
                            value="{{ auth()->user()->email }}">
                        <input hidden type="password" name="password" id="password"
                            value="{{ auth()->user()->password }}">
                        <input hidden type="text" name="role" id="role" value="2">
                        <button type="submit"
